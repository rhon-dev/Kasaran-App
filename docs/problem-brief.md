...
**Name locked: Kasaran.** For the record, "kasaran" reads closer to "roughness/coarseness" in Filipino while "kasalan" means wedding — this was raised and acknowledged. The decision is to proceed with **Kasaran** as the brand regardless, treating it as a distinct, ownable mark rather than a literal Tagalog word. Cleared for logo/domain.
...
7. **Name:** Confirmed — **Kasaran**, treated as a distinct brand mark (the "roughness" vs. "kasalan/wedding" nuance was acknowledged and set aside). Cleared for logo/domain.

*All decisions locked. No open items — ready for Prompt 2.*
